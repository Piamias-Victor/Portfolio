...
export function Header() {
    ...
    return <header className='w-full px-8 rounded-b-xl border-b border-default w-full sticky top-0 z-10 flex items-center justify-between h-[60px] md:h-[80px] bg-indigo3 dark:bg-indigodark3'>
        ...
        <div className="flex items-center gap-2 md:gap-8 text-sm md:text-base">
            <InternalDivisionLink href={"#skills"}>
                <ContrastTextButton className="w-[100px] md:w-[150px] bg-indigo4 dark:bg-indigodark4 text-colored" icon={RiStackLine}>
                    Stack
                </ContrastTextButton>
            </InternalDivisionLink>
            <InternalDivisionLink href={"#project"}>
                <ContrastTextButton className="w-[100px] md:w-[150px] bg-indigo4 dark:bg-indigodark4 text-colored" icon={AiOutlineFundProjectionScreen}>
                    Project
                </ContrastTextButton>
            </InternalDivisionLink>
            <InternalDivisionLink href={"mailto:victorpiamiaspro@outlook.fr?subject=Let's get to know each other"}>
                <ContrastTextButton className="w-[100px] md:w-[150px] bg-indigo4 dark:bg-indigodark4 text-colored" icon={RiContactsLine}>
                    Contact
                </ContrastTextButton>
            </InternalDivisionLink>
        </div>
